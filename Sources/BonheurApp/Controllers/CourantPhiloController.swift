...
////        }
//        
//        guard let planetePhilo = try await PlanetePhilo.query(on: req.db).first() else {
//            throw Abort(.notFound, reason : "Planete Philo introuvable")
//        }
//        
////         Créer une nouvelle instance de CourantPhilo
//        let courantPhilo = CourantPhilo(
//            id : UUID(),
//            planetePhiloID: planetePhilo.id!,
//            nom : newPhiloDTO.nom,
//            icon : newPhiloDTO.icon,
//            description : newPhiloDTO.description
//        )
//        
...
//    }
    ...
    @Sendable func CreatePhilo(_ req: Request) async throws -> CourantPhiloDTO {
        ...
        return CourantPhiloDTO(
            id: courantPhilo.id,
            planetePhiloId: courantPhilo.id,
            nom: courantPhilo.nom,
            icon: courantPhilo.icon,
            description: courantPhilo.description
        )
